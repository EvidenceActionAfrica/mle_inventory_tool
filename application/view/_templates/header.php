    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
        <div class="navbar-nav mx-auto d-flex align-items-center gap-3">
            <?php if($role === 'admin'|| $role === 'staff' || $role === 'super_admin'): ?>
                <a href="<?php echo URL; ?>inventoryassignment/pending" class="nav-item nav-link <?php echo isActive('inventoryassignment/pending', $current_page); ?>">PENDING ASSIGNMENTS</a>
            <?php endif; ?>

            <?php if($role === 'admin'||  $role === 'super_admin'): ?>
                <a href="<?php echo URL; ?>inventoryassignment" class="nav-item nav-link <?php echo isActive('inventoryassignment', $current_page); ?>">ASSIGNMENTS</a>
            <?php endif; ?>

            <?php if($role === 'admin'|| $role === 'staff' || $role === 'super_admin'): ?>
                <a href="<?php echo URL; ?>inventoryreturn" class="nav-item nav-link <?php echo isActive('inventoryreturn', $current_page); ?>">RETURN ITEM</a>
            <?php endif; ?>

            <?php if($role === 'admin'||  $role === 'super_admin'): ?>
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo isActive('unassignedItems', $current_page); ?>" href="#" data-bs-toggle="dropdown">ASSETS</a>
            ...
            <?php if($role === 'admin'|| $role === 'super_admin'): ?>
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo isActive('approve', $current_page); ?>" href="#" data-bs-toggle="dropdown">COLLECTIONS</a>
                    <div class="dropdown-menu">
            ...
            <?php if($role === 'admin'|| $role === 'staff' || $role === 'super_admin'): ?>
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo isActive('staffassignments', $current_page); ?>" href="#" data-bs-toggle="dropdown">REPORTS</a>
                    <div class="dropdown-menu">
                        <a href="<?php echo URL; ?>inventoryassignment/staffassignments" class="dropdown-item <?php echo isActive('staffassignments', $current_page); ?>">Staff Assignments</a>
                        <a href="<?php echo URL; ?>inventoryreturn/staffreturneditems" class="dropdown-item <?php echo isActive('staffreturneditems', $current_page); ?>">Staff Returned Items</a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if($role === 'admin'|| $role === 'super_admin'): ?>
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo isActive('inventory', $current_page); ?>" href="#" data-bs-toggle="dropdown">CONFIGURATIONS</a>
                    <div class="dropdown-menu">
                        <a href="<?php echo URL; ?>inventory" class="dropdown-item <?php echo isActive('inventory', $current_page); ?>">Inventory</a>
                        <a href="<?php echo URL; ?>categories/getCategory" class="dropdown-item <?php echo isActive('getCategory', $current_page); ?>">Categories</a>
                        <a href="<?php echo URL; ?>users/getUsers" class="dropdown-item <?php echo isActive('getUsers', $current_page); ?>">Users</a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if($role === 'super_admin'): ?>
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo isActive('getPositions', $current_page); ?>" href="#" data-bs-toggle="dropdown">ADMIN</a>
                    <div class="dropdown-menu">
                        <a href="<?php echo URL; ?>positions/getPositions" class="dropdown-item <?php echo isActive('getPositions', $current_page); ?>">Positions</a>
                        <a href="<?php echo URL; ?>department/getDepartments" class="dropdown-item <?php echo isActive('getDepartments', $current_page); ?>">Departments</a>
                        <a href="<?php echo URL; ?>office/getOffices" class="dropdown-item <?php echo isActive('getOffices', $current_page); ?>">Office</a>
                        <a href="<?php echo URL; ?>location/getLocations" class="dropdown-item <?php echo isActive('getLocations', $current_page); ?>">Location</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>
